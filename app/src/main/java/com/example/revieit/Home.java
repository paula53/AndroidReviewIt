...
import com.example.revieit.ViewHolder.MenuViewHolder;
...
import com.example.revieit.Model.Category;
...
public class Home extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent accDetails = new Intent(Home.this, AccountDetails.class);
            startActivity(accDetails);

        } else if (id == R.id.nav_search) {
            Intent search = new Intent(Home.this, BookList.class);
